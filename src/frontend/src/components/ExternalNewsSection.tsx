...
const ALL_NEWS: NewsItem[] = [
  ...
  {
    id: 46,
    title: "ঈদুল আযহার প্রস্তুতি: কোরবানির পশুর হাটে ক্রেতাদের ভিড়",
    summary:
      "ঈদুল আযহা উপলক্ষে সারাদেশে কোরবানির পশুর হাট জমে উঠেছে। গরু, ছাগল ও মহিষের ব্যাপক সরবরাহ থাকলেও দাম গত বছরের তুলনায় কিছুটা বেশি। ইসলামিক ফাউন্ডেশন কোরবানির নিয়ম-কানুন ও পশু জবাইয়ের শরিয়া পদ্ধতি সম্পর্কে জনসচেতনতা বাড়াতে প্রচারণা চালাচ্ছে। ধর্মপ্রাণ মুসলমানরা কোরবানির প্রস্তুতি নিচ্ছেন।",
    sourceUrl: "https://www.kalerkantho.com",
    sourceName: "কালের কণ্ঠ",
  ...
  {
    id: 47,
    title: "জুমার খুতবা: সমাজে শান্তি ও সম্প্রীতি প্রতিষ্ঠার আহ্বান",
    summary:
      "ঢাকার জাতীয় মসজিদ বায়তুল মোকাররমে জুমার খুতবায় সমাজে শান্তি, সহমর্মিতা ও ভ্রাতৃত্ব প্রতিষ্ঠার উপর জোর দেওয়া হয়েছে। ইমাম সাহেব কুরআন ও হাদিসের আলোকে মানুষের প্রতি দয়া ও ন্যায়বিচারের গুরুত্ব তুলে ধরেন। মুসল্লিরা খুতবায় একতার বার্তা পান। দেশের বিভিন্ন মসজিদেও একই বিষয়ে বয়ান করা হয়।",
    sourceUrl: "https://www.bd-pratidin.com",
    sourceName: "বাংলাদেশ প্রতিদিন",
    category: "ধর্মীয় অনুষ্ঠান",
    publishedAt: "৬ ঘন্টা আগে",
  ...
  {
    id: 48,
    title: "ইসলামিক ফাউন্ডেশনের বার্ষিক ধর্মীয় উৎসব ক্যালেন্ডার প্রকাশ",
    summary:
      "ইসলামিক ফাউন্ডেশন বাংলাদেশ আগামী বছরের ধর্মীয় উৎসব ও অনুষ্ঠানের ক্যালেন্ডার প্রকাশ করেছে। ঈদুল ফিতর, ঈদুল আযহা, শবে বরাত, শবে কদর ও পবিত্র মিলাদুন্নবীর তারিখ উল্লেখ করা হয়েছে। হিন্দু, বৌদ্ধ ও খ্রিষ্টান সম্প্রদায়ের উৎসবের তারিখও যুক্ত করা হয়েছে। ধর্মীয় সম্প্রীতি বজায় রাখার বার্তা দেওয়া হয়েছে।",
    sourceUrl: "https://www.prothomalo.com",
    sourceName: "প্রথম আলো",
    category: "ধর্মীয় অনুষ্ঠান",
  ...
  {
    id: 49,
    title: "হাওরের বুকে জীবন: সুনামগঞ্জের এক জেলে পরিবারের গল্প",
    summary:
      "সুনামগঞ্জের হাওর অঞ্চলে বাস করেন রহিম মিয়া ও তার পরিবার। বর্ষায় জলের মধ্যে নৌকায় জীবন কাটানো, আবার শুকনো মৌসুমে ধানের মাঠে কাজ — এই দুই ছন্দে বাঁধা তাদের জীবনচক্র। প্রজন্মের পর প্রজন্ম একই পেশায় টিকে থাকা মানুষগুলোর লড়াই আর স্বপ্নের কথা নিয়েই এই ফিচার স্টোরি। তবু তারা হাসিমুখে বলেন, এই হাওরই তাদের মায়ার বাঁধন।",
    sourceUrl: "https://www.prothomalo.com",
    sourceName: "প্রথম আলো",
  ...
  {
    id: 50,
    title: "ছোট্ট গ্রামের বড় বিজ্ঞানী: নওগাঁর কিশোরের রোবোটিক্সে জাতীয় পুরস্কার",
    summary:
      "নওগাঁর এক প্রত্যন্ত গ্রামের কিশোর আহমেদ ফারহান বাড়িতে বসেই তৈরি করেছে একটি কৃষি সহায়ক রোবট। স্থানীয় বিদ্যালয়ের শিক্ষকের উৎসাহে শুরু হওয়া তার যাত্রা আজ জাতীয় বিজ্ঞান অলিম্পিয়াডে প্রথম পুরস্কার পর্যন্ত পৌঁছেছে। বাবা-মায়ের স্বপ্ন এখন শুধু একটাই — ছেলেটা যেন পড়ালেখা করতে পারে। দেশের গ্রামীণ প্রতিভার অনুপ্রেরণামূলক কাহিনী।",
    sourceUrl: "https://www.deshrupantor.com",
    sourceName: "দেশ রূপান্তর",
    category: "ফিচার স্টোরি",
    publishedAt: "৮ ঘন্টা আগে",
  ...
  {
    id: 51,
    title: "নকশিকাঁথার সুতোয় বোনা ইতিহাস: বাংলার শিল্পকলার গর্বিত উত্তরাধিকার",
    summary:
      "বাংলাদেশের নকশিকাঁথা শুধু একটি কাপড় নয় — এটি প্রজন্মের স্মৃতি, মায়ের হাতের শিল্প, গ্রামবাংলার জীবনদর্শন। জামালপুরের কারিগর নারীরা এখনও রাত জেগে সূক্ষ্ম সুতার কাজে মেতে থাকেন। ইউনেসকোর স্বীকৃতির পরও এই শিল্পের কারিগরদের জীবনমান কতটা বদলেছে, তার খোঁজ নিয়েছে এই প্রতিবেদন।",
    sourceUrl: "https://www.samakal.com",
    sourceName: "সমকাল",
    category: "ফিচার স্টোরি",
    publishedAt: "১ দিন আগে",
  ...
  {
    id: 52,
    title: "বাংলাদেশের নদী নিয়ে নতুন প্রামাণ্যচিত্র: আন্তর্জাতিক পুরস্কার",
    summary:
      "বাংলাদেশের তরুণ চলচ্চিত্র নির্মাতা রায়হান রহমানের প্রামাণ্যচিত্র 'নদীর কথা' সম্প্রতি বার্লিন চলচ্চিত্র উৎসবে আন্তর্জাতিক পুরস্কার জিতেছে। পদ্মা, মেঘনা ও যমুনার মানুষের জীবনযাত্রা এবং নদীর সাথে তাদের গভীর সম্পর্ক নিয়ে নির্মিত এই প্রামাণ্যচিত্রটি আন্তর্জাতিক দর্শকদের মুগ্ধ করেছে। চলচ্চিত্রটি শীঘ্রই দেশে মুক্তি পাবে।",
    sourceUrl: "https://www.bdnews24.com",
    sourceName: "BD News24",
    category: "মাল্টিমিডিয়া",
    publishedAt: "৫ ঘন্টা আগে",
    sourceGroup: "online",
  },
  {
    id: 53,
    title: "ঢাকায় বৃহৎ ফটোগ্রাফি প্রদর্শনী: সাতশো বছরের পুরানো ঢাকার ছবি",
    summary:
      "জাতীয় জাদুঘরে শুরু হয়েছে 'পুরান ঢাকার রূপ' শীর্ষক এক ব্যতিক্রমী আলোকচিত্র প্রদর্শনী। শতাধিক ঐতিহাসিক ও সমকালীন ফটোগ্রাফের মাধ্যমে মোগল আমল থেকে আধুনিক নগরীতে ঢাকার রূপান্তরের গল্প বলা হচ্ছে। প্রথম দিনেই হাজার হাজার দর্শক প্রদর্শনী দেখতে এসেছেন। এটি ১৫ দিন ধরে চলবে।",
    sourceUrl: "https://www.dhakapost.com",
    sourceName: "Dhaka Post",
    category: "মাল্টিমিডিয়া",
    publishedAt: "৭ ঘন্টা আগে",
  ...
  {
    id: 54,
    title: "ভিডিও সাংবাদিকতায় পুরস্কার: তরুণ রিপোর্টারদের সাফল্য",
    summary:
      "বাংলাদেশ প্রেস ইনস্টিটিউট আয়োজিত ভিডিও সাংবাদিকতা পুরস্কারে এ বছর তরুণ সাংবাদিকরা অসাধারণ সাফল্য দেখিয়েছেন। সেরা ভিডিও রিপোর্টের পুরস্কার পেয়েছেন রাজশাহীর স্থানীয় একটি চ্যানেলের সাংবাদিক। পরিবেশ সংকট নিয়ে তৈরি ভিডিও রিপোর্টটি বিশেষভাবে প্রশংসিত হয়েছে। ডিজিটাল সাংবাদিকতায় নতুন প্রজন্মের আগ্রহ বাড়ছে।",
    sourceUrl: "https://www.banglanews24.com",
    sourceName: "Bangla News24",
    category: "মাল্টিমিডিয়া",
    publishedAt: "১ দিন আগে",
...
const CATEGORY_IMAGES: Record<string, string> = {
  ...
  "ধর্মীয় অনুষ্ঠান": "/assets/generated/thumb-politics.dim_300x200.jpg",
  "ফিচার স্টোরি": "/assets/generated/thumb-education.dim_300x200.jpg",
  মাল্টিমিডিয়া: "/assets/generated/thumb-international.dim_300x200.jpg",
};
...
export function ExternalNewsSection({
  ...
  // When categoryFilter changes (from nav click on শিক্ষা/স্বাস্থ্য etc.)
  useEffect(() => {
    if (categoryFilter) {
