  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4", children: picks.map((pick, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "article",
          {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-1.5 z-10", children: slides.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function LatestNews() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "aria-labelledby": "latest-news-heading", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: latestNews.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "article",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] mt-1.5", style: { color: "#6b6b6b" }, children: [
              item.author,
              " · ",
              item.time
            ] })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { backgroundColor: "#0b0b0b" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1200px] mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LatestNews, {}) })
    ] }),
...
const BreakingNews = Record({
  "id": Nat,
  "createdAt": Time,
  "text": Text
});
Service({
  "addAdmin": Func([Principal2], [], []),
  "createArticle": Func(
    [Text, Text, Text, Text, Text, Bool],
    [Nat],
    []
  ),
  "createBreakingNews": Func([Text], [Nat], []),
  "getAllArticles": Func([], [Vec(Article)], ["query"]),
  "getAllBreakingNews": Func([], [Vec(BreakingNews)], ["query"]),
  "getArticle": Func([Nat], [Article], ["query"]),
  "getFeaturedArticles": Func([], [Vec(Article)], ["query"])
});
